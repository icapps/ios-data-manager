...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DataManager"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Jelle Vandebeeck" => "jelle@fousa.be" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DataManager.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'DataManager' => ['DataManager/Assets/*.png']
  }
